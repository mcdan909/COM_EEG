...
for i = 1:length(goodSubs)
    ...
    fileName = strcat(goodSubs{i},'_',prefix,'_ERP_WithHiCoh_QuartCurv',suffix,filt,'.erp');
    fileNameCSD = strcat('/CSD/',goodSubs{i},'_',prefix,'_ERPcsd_WithHiCoh_QuartCurv',suffix,filt,'.erp');
