...
erpSuffixOrig = strcat('_',prefix,'_ERP_WithHiCoh_QuartCurv',suffix,'_ContraIpsi',filt,'.erp');
erpSuffixCSD = strcat('_',prefix,'_ERPcsd_WithHiCoh_QuartCurv',suffix,'_ContraIpsi',filt,'.erp');
...
ALLERP = pop_jkgaverager(ALLERP , 'Erpname', strcat('GoodSubAvg_',prefix,'_ERP_WithHiCoh_QuartCurv',suffix,'_ContraIpsi',filt),...
    'Erpsets', 1:length(goodSubs), 'Criterion', 30, 'SEM', 'on',...
    'Filename', strcat('GoodSubAvg_',prefix,'_ERP_WithHiCoh_QuartCurv',suffix,'_ContraIpsi',filt,'.erp'));

% Make a folder for the Jackknife subaverages
mkdir 'Jackknife';

% Rename the original file and move the jackknife files to the folder
movefile(strcat('GoodSubAvg_',prefix,'_ERP_WithHiCoh_QuartCurv',suffix,'_ContraIpsi',filt,'-00.erp'),...
    strcat('GoodSubAvg_',prefix,'_ERP_WithHiCoh_QuartCurv',suffix,'_ContraIpsi',filt,'.erp'));
...
%     'Erpsets', 1:length(goodSubs), 'Criterion', 30, 'SEM', 'on' );
ALLERP = pop_jkgaverager(ALLERP , 'Erpname', strcat('GoodSubAvg_',prefix,'_ERPcsd_WithHiCoh_QuartCurv',suffix,'_ContraIpsi',filt),...
    'Erpsets', 1:length(goodSubs), 'Criterion', 30, 'SEM', 'on',...
    'Filename', strcat('GoodSubAvg_',prefix,'_ERPcsd_WithHiCoh_QuartCurv',suffix,'_ContraIpsi',filt,'.erp'));

% Make a folder for the Jackknife subaverages
mkdir 'Jackknife';

% Rename the original file and move the jackknife files to the folder
movefile(strcat('GoodSubAvg_',prefix,'_ERPcsd_WithHiCoh_QuartCurv',suffix,'_ContraIpsi',filt,'-00.erp'),...
    strcat('GoodSubAvg_',prefix,'_ERPcsd_WithHiCoh_QuartCurv',suffix,'_ContraIpsi',filt,'.erp'));
movefile('*-0*','Jackknife');
movefile('*-10*','Jackknife');
